  ...
  return (
    <div className="group-32">
      <div className="group-189">
        ...
        <p className="text-29 typographybody16-regular">
      ...
      <div className="group-18">
        ...
        <div className="text-3-1 valign-text-middle typographybody16-regular">+91 8976535221, +91 8755645342</div>
      </div>
      <div className="group-18">
        <div className="mail">
        ...
        <div className="text-3-1 valign-text-middle typographybody16-regular">contact@webuild.com</div>
      </div>
    </div>
  );
}
